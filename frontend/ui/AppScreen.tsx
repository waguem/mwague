...
AppScreen.Header = forwardRef(function AppScreenHeader({ children }: any, ref: any) {
  return (
...
AppScreen.Title = forwardRef(function AppScreenTitle({ children }: any, ref: any) {
  return (
...
AppScreen.Subtitle = forwardRef(function AppScreenSubtitle({ children }: any, ref: any) {
  return (
...
AppScreen.Body = forwardRef(function AppScreenBody({ children, className }: any, ref: any) {
  return (
