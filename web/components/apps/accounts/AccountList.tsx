...
export default async function AgentAccountsList({ agentInitials }: Props) {
  const accounts = await getAgentAccounts(agentInitials);
  ...
  return (
    <div className="flex gap-4 justify-between">
      {accounts.map((account: AccountResponse, index: string) => (
