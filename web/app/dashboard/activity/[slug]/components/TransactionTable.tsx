        ...
        <div className="flex-1 justify-center">
          <Tippy content="Refresh data">
            <button
              ...
              onClick={() => fetchRevalidatePath(`/dashboard/activity/${slug}/transactions`)}
            >
      ...
      <div className="p-1">
        ...
        {onReview > -1 && (
          <div className="flex w-full flex-row justify-center">
            <QuickReview
              show={onReview > -1}
              revalidatePath={`/dashboard/activity/${slug}/transactions`}
              transaction={transactions[onReview]}
              onClose={() => setOnReview(-1)}
            />
          </div>
        )}
      </div>
